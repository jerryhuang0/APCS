...
/**
 * Write a description of class CandidateTesterV8 here.
 *
...
public class CandidateTesterV8
{
    ...
    public static void deleteCandidateByPosition(List<Candidate> array, int pos)
    {
    ...
    public static void deleteCandidateByName(List<Candidate> array, String name)
    {
        int pos = 0;
