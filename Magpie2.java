 ...
 * @Jan 24, 2018 (enter today's date)
 */
public class Magpie2
{
    ...
    public String getResponse(String statement)
    {
        ...
        {
            response = "Your family sure sounds interesting!";
        }
        else if(findKeyword(statement, "brother") >= 0)
        {
            response = "Is your brother nice to you?";
        }
        else if(findKeyword(statement,"dog") >= 0
                || findKeyword(statement,"cat") >= 0)
        {
            response = "Do you have any more pets?";
        }
        else if (findKeyword(statement,"dinner") >= 0)
        {
            response = "What did you have for lunch?";
                ...
                || findKeyword(statement,"Krumenacker") >= 0)
        {
            response = "What do you do in class?";
        }
        else if (findKeyword(statement,"school") >= 0)
        {
            response = "Don't be late!";
        }
        else
        {
    ...
    private String getRandomResponse()
    {
        ...
        {
            response = "That might be so";
        }
        else if (whichResponse == 5)
        {
            response = "Follow what your heart says";
        }
